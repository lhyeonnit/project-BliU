...
class HomeBodyAiChildWidget extends ConsumerStatefulWidget {
  const HomeBodyAiChildWidget({super.key});

  @override
  ConsumerState<HomeBodyAiChildWidget> createState() => HomeBodyAiChildWidgetState();
}

class HomeBodyAiChildWidgetState extends ConsumerState<HomeBodyAiChildWidget> {
