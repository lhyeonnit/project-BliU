import 'package:BliU/screen/_non/non_mypage/bottom/component/non_terms_detail.dart';
...
class NonSettingPage extends ConsumerWidget {
  const NonSettingPage({super.key});
                ...
                children: [
                  ...
                  _buildCustomTile(
                    context, '이용약관',
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const NonTermsDetail(type: 0)),
                      );
                    },
                  ),
                  _buildCustomTile(
                    context, '개인정보처리방침',
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const NonTermsDetail(type: 1)),
                      );
                    },
                  ),
                ],
