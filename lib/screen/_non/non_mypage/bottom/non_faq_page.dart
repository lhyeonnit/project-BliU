...
class NonFaqPage extends ConsumerStatefulWidget {
  const NonFaqPage({super.key});

  @override
  _NonFaqPageState createState() => _NonFaqPageState();
}

class _NonFaqPageState extends ConsumerState<NonFaqPage> {
