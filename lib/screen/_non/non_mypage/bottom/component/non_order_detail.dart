...
import 'non_order_item.dart';

class NonOrderDetail extends StatefulWidget {
  final String date;
  ...
  @override
  State<NonOrderDetail> createState() => _NonOrderDetailState();
}

final ScrollController _scrollController = ScrollController();

class _NonOrderDetailState extends State<NonOrderDetail> {
  @override
                ...
                Container(
                  ...
                  child: Column(
                    children: widget.orders.map((order) {
                      return NonOrderItem(order: order, orderDetails: widget.orderDetails,);
                    }).toList(),
                  ),
                ),
                // 배송비 정보
