...
import 'package:BliU/screen/_non/non_mypage/bottom/component/non_notice_detail.dart';
...
class NonNoticeList extends ConsumerWidget {
  // TODO 페이징
  var pg = 0;

  NonNoticeList({super.key});
                      ...
                      onTap: () {
                        ...
                        if (ntIdx != null) {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => NonNoticeDetail(
                                ntIdx: ntIdx,
                              ),
                            ),
                          );
