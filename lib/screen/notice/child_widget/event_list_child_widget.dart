...
class EventListChildWidget extends ConsumerStatefulWidget {
  const EventListChildWidget({super.key});

  @override
  ConsumerState<EventListChildWidget> createState() => EventListChildWidgetState();
}

class EventListChildWidgetState extends ConsumerState<EventListChildWidget> {
