...
class LikeProductTabBarViewModel {}

class LikeProductTabBarViewViewModel extends StateNotifier<LikeProductTabBarViewModel?> {
  final Ref ref;
  final repository = DefaultRepository();

  LikeProductTabBarViewViewModel(super.state, this.ref);
...
final likeProductTabBarViewModelProvider =
StateNotifierProvider<LikeProductTabBarViewViewModel, LikeProductTabBarViewModel?>((ref) {
  return LikeProductTabBarViewViewModel(null, ref);
});