...
class StoreCouponBottomModel {
}

class StoreCouponBottomViewModel extends StateNotifier<StoreCouponBottomModel?> {
  final Ref ref;
  final repository = DefaultRepository();

  StoreCouponBottomViewModel(super.state, this.ref);
...
final storeCouponBottomViewModelProvider =
StateNotifierProvider<StoreCouponBottomViewModel, StoreCouponBottomModel?>((req) {
  return StoreCouponBottomViewModel(null, req);
});