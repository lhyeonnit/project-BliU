...
class MyInquiryOneChildWidget extends ConsumerStatefulWidget {
  const MyInquiryOneChildWidget({super.key});

  @override
  ConsumerState<MyInquiryOneChildWidget> createState() => MyInquiryOneChildWidgetState();
}

class MyInquiryOneChildWidgetState extends ConsumerState<MyInquiryOneChildWidget> {
