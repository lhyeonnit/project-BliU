                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: GestureDetector(
                          onTap: () async {
                            // 아이디찾기 버튼 동작
                            final result = await Navigator.pushNamed(context, 'find_id');

                            if (result != null) {
                              if(!context.mounted) return;

                              Navigator.pushNamed(context, '/terms_detail/$result');
                            }
                          },
                          child: Text(
                            '아이디찾기',
